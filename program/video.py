...
async def vplay(c: Client, m: Message):
    ...
    if replied:
        if replied.video:
            loser = await replied.reply("Downlding") 
            dl = await replied.download_video(file_name=replied.video.file_name, progress=progress, progress_args=("Downloading:",loser, start_time))
